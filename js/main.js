...
fillRestaurantsHTML = (restaurants = self.restaurants) => {
  ...
  restaurants.forEach(restaurant => {
    ele.append(createRestaurantHTML(restaurant));
  });
  ul.append(ele);
  addMarkersToMap();
}
...
createRestaurantHTML = (restaurant) => {
  ...
  div.setAttribute('class', 'restaurant-details');
  ...
  neighborhood.setAttribute('aria-label', `situated in ${restaurant.neighborhood}`)
